...
\]
The correction factors are stored in \texttt{self.acf\_corrections\_} and reported by \texttt{check\_exchangeability()}. This implements the compensation dictated by Theorem~\ref{thm:autocorrelation}: the quantile inflation restores the $1-\alpha$ coverage guarantee by widening intervals proportional to the standard-error inflation from autocorrelation.
